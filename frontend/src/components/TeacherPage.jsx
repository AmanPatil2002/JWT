  ...
  useEffect(() => {
    const generateTeacherData = () => {
      ...
      return {
        ...
        department: faker.helpers.arrayElement(["Science","Mathematics","Computer Science","English",]),
        designation: faker.helpers.arrayElement(["Teacher","Senior Teacher","Head of Department",]),
    ...
    <div className="min-h-screen bg-gray-100 flex justify-center items-center">
      <div className="bg-white shadow-lg rounded-xl p-8 w-full max-w-md">
        <div className="text-center">
          <img src={teacherInfo.avatar} alt="teacher" className="w-24 h-24 rounded-full mx-auto mb-4"/>
